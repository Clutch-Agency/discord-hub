...
Adicione estes escopos ao convite do bot:
...
- Presence Intent, caso o projeto utilize
- Message Content Intent, caso o projeto utilize
...
Copie e execute o comando exibido pelo PM2.
...
- Resumo do que foi feito:
  - Instalação inicial do Discord Hub em VPS concluída.
- Arquivos criados/alterados:
  - `/root/discord-hub/.env`
  - `/etc/nginx/sites-available/discord-hub`
- Decisões tomadas:
  - Next.js configurado na porta `2828`.
  - API interna do bot configurada na porta `2829`.
  - PM2 configurado para gerenciar site e bot.
  - Nginx configurado como proxy reverso.
  - Certbot configurado para SSL.
- Erros encontrados:
  - Nenhum.
- Como foi corrigido:
  - Não aplicável.
- Estado atual do build:
  - Projeto instalado, compilado e executado via PM2.
- Próximo passo único:
  - Validar login Discord, conexão do bot e criação de Hub de voz.
